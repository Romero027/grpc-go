...
import (
	...
	_ "github.com/Romero027/grpc-go/balancer/grpclb"               // grpclb for config parsing.
	_ "github.com/Romero027/grpc-go/internal/resolver/passthrough" // passthrough resolver.
)
