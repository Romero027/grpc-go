...
// Handler implements [stats.Handler](https://pkg.go.dev/github.com/Romero027/grpc-go/stats#Handler) interface.
type Handler struct{}
...
// New returns a new implementation of [stats.Handler](https://pkg.go.dev/github.com/Romero027/grpc-go/stats#Handler) interface.
func New() *Handler {
	return &Handler{}
}
